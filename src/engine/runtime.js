...
class Runtime extends EventEmitter {
    ...
    /**
     * Event name for Github Integration changing.
     * @const {string}
     */
    static get GITHUB_CHANGED() {
    ...
    /**
     * tw: Enable or disable Github Integration.
     * @param {boolean} githubEnabled True if Github Integration should be enabled.
     */

    setGithubEnabled(githubEnabled) {
        this.githubEnabled = githubEnabled;
        this.storeProjectOptions();
        this.emit(Runtime.GITHUB_CHANGED, githubEnabled);
    }
